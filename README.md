...
## Live Dashboard
Explore the live dashboard [here](https://app.powerbi.com/view?r=eyJrIjoiNDljMTY4NTktOWNhMC00NjIyLWI3ZTAtYjNiMTliMTRlZDJkIiwidCI6ImM2ZTU0OWIzLTVmNDUtNDAzMi1hYWU5LWQ0MjQ0ZGM1YjJjNCJ9).
...
2. **MySQL Database:** Facts and Dimensions for all departments are retrieved from [MySQL database].
...
## Acknowledgments
Special thanks to mentors, Hemanand Vadivel and Dhaval Patel. This project was part of the Power BI course offered by CodeBasics.
